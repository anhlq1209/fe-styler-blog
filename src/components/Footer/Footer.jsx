  ...
  return (
    <section className="bg-dark-hard">
      ...
      >
        ...
        <div className="col-span-5 md:col-span-4 md:col-start-5 lg:col-span-2 lg:sol-start-auto">
        ...
        <div className="sol-span-10 md:order-first md:col-span-4 lg:col-span-2">
          <img
            src={images.Logo}
            alt="logo"
